# -*- coding: utf-8 -*-
"""
"The Soul Garden" narration (089 English, 14 slides, 1:1 with the deck).
Thread: p1 hook (the soul garden is not a metaphor -- it is your consciousness) -> p2 consciousness,
garden and LIFE structure are one thing -> p3 the frequency gate -> p4 two everyday inventories
-> p5 the energy scale (garden first, reading second) -> p6 every crisis begins as a crisis of the heart
-> p7 four purposes, all subtraction -> p8 three energy sources: what makes weeding possible
-> p9 five steps: contamination is instant, clearing is slow -> p10 the collective as the practice field
-> p11 inner state and the body -> p12 eight rules, set only for yourself -> p13 chaos-management as an
inference -> p14 the garden was always bright.
Length: **5:00-10:00, target 8:30-9:30** (upper bound set by the user 2026-09-06). Measured Andrew +0%
   is about **15.1 characters per second**, so the body runs about **8,000 characters, 3-4 sentences a
   slide, roughly 570 characters a slide**. Run `--stills` before rendering; over 600 seconds, cut setup
   sentences only -- never the guardrail clauses below.
Guardrails (all seven): (1) The energy numbers must be named as **a scale of consciousness this framework
   borrows -- a way of thinking, not a medical measurement**. (2) p11 must carry the line that this is
   **what the framework holds about inner state and physical reality, not medical advice, and no substitute
   for seeing a doctor** -- this is the safety valve of the whole piece and is never cut. (3) p6 reports
   the passage on nations and civilization at face value, with **no allusion to any real country, party or
   event**. (4) Anything touching the Second Home (p10, p12) is **stated as fact, never promoted, and
   carries no invitation**. (5) Both inventories say plainly **these are only some of them**. (6) Name no
   Chanyuan Celestial. (7) "Formatting consciousness" is explained as the source explains it -- replacing
   a mode of thinking, not erasing a person.
Positioning: **072 Purifying the Mind** has aired and is the entry this one most easily collides with --
   its five reframings, four benefits, five routes and skylight metaphor are **never repeated here**.
   **088 Formless Giving** has just aired: one bridging line. **090 Fluid Adaptability** is next -- named
   only. Antimatter Structure, frequency, chaos-management and the Elysium World each have their own entry.
Voice: Andrew. Written from the English source draft, not translated. First line = hook.
"""
...
META = [
    {"quote": "Not a metaphor. It is your consciousness."},
    {"quote": "You think you are sorting your mood"},
    {"quote": "Nobody is at the door. The frequency simply matches or does not."},
    {"quote": "Two inventories, and nothing mystical on either"},
    {"quote": "First the garden, then the reading"},
    {"quote": "Every crisis begins as a crisis of the heart"},
    {"quote": "Four purposes, and all of them subtract"},
    {"quote": "Without energy, nothing gets pulled"},
    {"quote": "Contamination is instant. Clearing is slow."},
    {"quote": "Weeds only show themselves when brushed"},
    {"quote": "Pull the weed and the mood resolves"},
    {"quote": "Eight rules, every one about yourself"},
    {"quote": "The cleaner the heart, the fewer the fences"},
    {"quote": "The garden was always bright"},
]

SLIDES = [
    ("slides_sg_en/slide_01.png", [
        "Soul garden sounds like a gentle figure of speech. In this framework it is not one.",
        "The definition Xuefeng gives is a single line: a person's soul garden is that person's consciousness.",
        "Which sets up an equation. Whatever grows in the consciousness is what the garden is. And whatever the garden is, that is what this LIFE becomes.",
        "Which is why he can say that purifying people's inner spirits — soul garden construction — is humanity's top priority.",
    ]),
    ...
    ("slides_sg_en/slide_09.png", [
        "The method is five steps, and it is slow work.",
        "One, recognize and observe: face yourself honestly, review your own faults, see where the weeds actually are without dodging. Two, clear the weeds: pull out jealousy, comparison, anger, selfishness, arrogance, fear.",
        "Three, sow the flowers: plant truth, goodness, beauty, love, faith, sincerity. Four, feed it continuously: read to shift the thinking, be tempered by collective living, take part in labor and formless giving, hold gladness through play.",
    ...
    ("slides_sg_en/slide_11.png", [
        ...
        "Its words: physical illness is rooted in defects of spirit and heart; as a person's spirit and heart become more complete, not only will illness not arise, existing conditions will gradually resolve.",
        "The causal story it offers: when the garden fills with comparison, jealousy, anger, arrogance and complaint, anxiety and suffering have found their root cause. Pull those weeds out, and the moods resolve without being treated directly.",
