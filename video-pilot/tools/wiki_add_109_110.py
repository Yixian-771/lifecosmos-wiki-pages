# -*- coding: utf-8 -*-
"""109–110 上站：中英 4 个词条页接入视频版（YouTube 无 Cookie 嵌入）与图文幻灯图集。
...
ENTRIES = [  # 序号, slug, 中文名, 英文名, 中文ID, 英文ID
    (109, "labor-as-first-need", "劳动为生活第一需要", "Labor as the First Need of Life", "EFecmpAwjic", "y5wypTOUZdk"),
    (110, "hundun-economy", "浑沌经济·市场经济·计划经济", "Hundun Economy · Market Economy · Planned Economy", "jtPF24FvlbY", "s4riUaiIvcE"),
]
