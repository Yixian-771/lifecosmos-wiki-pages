<!-- id: LC-0175-EN-ACADEMIC theme: cultivation type: wiki lang: en -->
...
- **随** (*suí*): to follow, accord with — without forcing or resisting
- **性** (*xìng*): heavenly nature, original nature, tathāgata-nature (*rúlái běnxìng*) — not *xíxìng* (习性, acquired habit-nature)
...
**Distinction from Confucian "follow without transgression":** Confucius's principle still operates within the constraint of ritual propriety (*lǐ*). In the Lifechanyuan framework, the impulse of true *xìng* is inherently aligned with the Dao — it *is* the Dao's expression — and therefore requires no external constraint. "Not transgressing" is a natural consequence, not a limiting condition.
