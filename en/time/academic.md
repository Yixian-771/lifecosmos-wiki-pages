...
1. Time is the recorder of matter's state of motion — not an independent reality.
2. Time is antimatter — real but physically imperceptible.
3. The antimatter world has no time and is therefore eternal.
4. Time is a variable: different spaces, masses, and motion states produce different times.
5. Longitudinal time governs the body; lateral time is accessible to the soul.
6. Following time, one becomes mortal; going against time, one becomes immortal.
7. The Time Trap (seventh of the Thirty-Six Trigram Formations) is a key spiritual obstacle.
8. Three paths to transcendence: the bipolar method, moving against time, and consciousness entry into lateral space-time.
